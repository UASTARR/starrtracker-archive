...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWindow->setGeometry(QRect(0, 0, 1300, 815));
        tabWindow->setTabsClosable(true);
        tabWindow->setMovable(true);
        addSensor = new QPushButton(centralwidget);
        addSensor->setObjectName(QString::fromUtf8("addSensor"));
        addSensor->setGeometry(QRect(1190, 0, 105, 29));
